...
export function createRankingScreen(store: GameStore): HTMLElement {
    ...
    footer.style.cssText =
        'padding-top: 1.5rem; padding-bottom: var(--dock-clearance);';

    const homeBtn = el<HTMLButtonElement>(
        'button',
    ...
    homeBtn.addEventListener('click', () =>
        store.update(Actions.confirmEndGame())
    );
